...
class EditViewModels {
    lazy var cancelButton: UIButton = {
        return setupCancelButton(tag: 1)
    }()
    ...
    func setupData(offer: OfferStruct) {
        amountToSellField.text = offer.amountToSell.description
        amountToBuyField.text = offer.amountToBuy.description
        fromCurrencyLabel.text = offer.fromCurrency.capitalName
        toCurrencyLabel.text = offer.toCurrency.capitalName
        currencyToSellField.text = offer.fromCurrency.capitalName
        currencyToBuyField.text = offer.toCurrency.capitalName
        toRateField.text = offer.exchangeRate.description
    }
    
    func setupViews(parrent: UIView, offer: OfferStruct) {
        ...
        NSLayoutConstraint.activate([
            ...
            amountToSellField.topAnchor.constraint(equalTo: parrent.safeAreaLayoutGuide.topAnchor, constant: 68),
            ...
            amountToSellLabel.topAnchor.constraint(equalTo: parrent.safeAreaLayoutGuide.topAnchor, constant: 38),
            ...
            amountToBuyLabel.bottomAnchor.constraint(equalTo: amountToBuyField.safeAreaLayoutGuide.topAnchor, constant: -10),
            ...
            saveChangesButton.bottomAnchor.constraint(equalTo: parrent.safeAreaLayoutGuide.bottomAnchor, constant: -30),
